...
$resultInsert2 = mysqli_query($con, "INSERT INTO `fil01mail`
	(`emisor`,`destinatario`, `asunto`, `cuerpo`, `fecha`, `adjunto`, `tipo_ingreso`, `estado`, `nro_ticket`, `fecha_ticket`, `nombre_ticket`,`cod_entidad`,`categoria`,`tipo_ticket`,`expediente`) 
	VALUES 
	('$emisor','$destinatario','$asunto','$cuerpo','$fechaticket','N','P','$estado','$nro_ticket','$fechaticket','$nombreticket','$entidades','$etiquetas','$tipo_ticket','$expediente')");
if (!$resultInsert2) {
