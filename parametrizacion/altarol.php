...
<form class="form-inline" id="formulario">
  <input type="text" name="parcod" value="1" hidden>
...
<button type="button" class="btn btn-primary mb-2" onclick="validar_form_parametrizacion('rol','alta','_alta.php');">Confirmar</button>
