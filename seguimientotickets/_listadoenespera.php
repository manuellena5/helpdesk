...
$query= "SELECT DISTINCT m3.nro_ticket,m1.emisor,m1.asunto,m3.fechaasig,IF(fadj.id_file is not null,'S','N')adjunto,m3.id_mail,m1.cuerpo,m3.observacion,m3.estado,m3.id,m3.leido,m3.tipo_ticket,f01ent.razon,m1.cod_entidad
FROM `fil03mail` m3
...
WHERE (m3.`usuarioasig`='$nrousuario') and (m3.estado='R' or m3.estado is null)
