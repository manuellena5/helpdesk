...
print_r($_FILES);
 $.fn.dataTable.ext.errMode = 'none';
  ...
  var asd = $("#fechamin").datepicker({ onSelect: function () { table.draw(); },dateFormat: 'dd/mm/y', changeMonth: true, changeYear: true });
  console.log(asd);
  
  $("#fechamax").datepicker({ onSelect: function () { table.draw(); },dateFormat: 'dd/mm/y', changeMonth: true, changeYear: true });  
